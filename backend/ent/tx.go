...
func (tx *Tx) init() {
	tx.ScholarshipRequest = NewScholarshipRequestClient(tx.config)
	tx.Scholarshipinformation = NewScholarshipinformationClient(tx.config)
...
// applies a query, for example: ScholarshipRequest.QueryXXX(), the query will be executed
