...
func (e UserEdges) ScholarshipRequestOrErr() ([]*ScholarshipRequest, error) {
	if e.loadedTypes[0] {
...
// QueryScholarshipRequest queries the ScholarshipRequest edge of the User.
func (u *User) QueryScholarshipRequest() *ScholarshipRequestQuery {
	return (&UserClient{config: u.config}).QueryScholarshipRequest(u)
}
